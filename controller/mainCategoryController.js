...
exports.updateMainCategory = async (req, res) => {
  ...
  try {
    ...
    mainCategory.isChecked =
      isChecked !== undefined ? isChecked : mainCategory.isChecked;
...
exports.updateMainTargetGoal = async (req, res) => {
  ...
  try {
    ...
    mainGoal.isChecked =
      isChecked !== undefined ? isChecked : mainGoal.isChecked;
...
exports.deleteMainTargetGoal = async (req, res) => {
  ...
  try {
    ...
    const goalIndex = mainCategory.mainGoals.findIndex(
    ...
    res
      .status(500)
      .json({
        message: "Error deleting main target goal",
        error: error.message,
      });
  }
};
...
exports.deleteSubTargetGoal = async (req, res) => {
  ...
  try {
    ...
    const subGoalIndex = mainGoal.subGoals.findIndex(
      (subGoal) => subGoal._id.toString() === subGoalId
    );
    ...
    res
      .status(500)
      .json({
        message: "Error deleting sub-target goal",
        error: error.message,
      });
  }
};
